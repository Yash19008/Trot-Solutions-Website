/**
 * Mock Plugins Polyfill
 * Prevents script.js from crashing if page-specific plugins (like owlCarousel, isotope)
 * are not loaded on the current page.
 */
if (typeof jQuery !== 'undefined') {
  if (typeof jQuery.fn.owlCarousel === 'undefined') jQuery.fn.owlCarousel = function() { return this; };
  if (typeof jQuery.fn.isotope === 'undefined') jQuery.fn.isotope = function() { return this; };
  if (typeof jQuery.fn.datepicker === 'undefined') jQuery.fn.datepicker = function() { return this; };
  if (typeof jQuery.fn.ptTimeSelect === 'undefined') jQuery.fn.ptTimeSelect = function() { return this; };
}
...
window.initThemeScripts = function() {
  ...
  if ($(".services-one__carousel").length > 0) {
    const servicesCarousel = new Swiper('.services-one__carousel', {
      "slidesPerView": 1,
      "spaceBetween": 30,
      "speed": 600,
      "loop": true,
      ...
      let observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            servicesCarousel.slideToLoop(0, 0); 
            observer.unobserve(entry.target);
          }
        });
      }, { threshold: 0.1 });
      
      observer.observe(document.querySelector('.services-one__carousel'));
    }
  }
...
if (typeof jQuery !== "undefined") {
  // window.initThemeScripts(); // called by Next.js
}